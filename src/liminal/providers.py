...
EXECUTOR_PROFILES: dict[str, ExecutorProfile] = {
    ...
    "claude": ExecutorProfile(
        ...
        model_placeholder_zh="sonnet 或 claude-sonnet-4-6",
        model_placeholder_en="sonnet or claude-sonnet-4-6",
        model_help_zh="使用本机 Claude Code CLI。可以填别名 sonnet / opus，或完整模型名。",
        model_help_en="Uses the local Claude Code CLI. You can use aliases like sonnet / opus or a full model name.",
        effort_label_zh="推理强度",
